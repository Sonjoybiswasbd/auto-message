...
- If the customer appears to be from Chittagong (based on what they say, their location, or
  ...
  },
  {
    ...
    businessInfo: `Vagyashreeshop is a Bangladeshi clothing shop based in Reazuddin Bazar (Teribazar),
Chittagong. It sells men's traditional/ethnic clothing, mainly for special occasions (weddings,
gaye holud, puja, family photoshoots, mukhe bhaat, etc.). Sells only via this Facebook Page
(no website).
